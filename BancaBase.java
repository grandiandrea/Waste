import java.util.*;
public class BancaBase{
	public static void main(String[] args){
		Scanner reader = new Scanner(System.in);
		contoBase conto1 = null;
		while(true){
			...
			if(inpt.equals("a")){
				...
				System.out.println("Inserisci prelievo massimo");
				double maxPrelievo = reader.nextDouble();
				conto1 = new contoBase(saldo,intestatario,generateRandomChars("123456789",10),maxPrelievo);
				System.out.println("Numero conto = "+conto1.getNConto());
			}
